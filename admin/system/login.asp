	...
	<form name="form1" method="post" action="login.asp">
		...
		<div>
			<table cellspacing="0">
				<tr>
					<td>
						<p style="line-height:30px;"><label>UserName:</label><input class="in2" size="14" type="text" name="adminname" maxlength="12" /></p>
						<p style="line-height:26px;"><label>Password:</label><input class="in2" size="14" type="password" name="adminpass" maxlength="30" /></p>
					</td>
					<th>
						<p class="WO_menu"><input type="submit" value="Login" style="padding:14px 6px;margin-left:10px;" /></p>
					</th>
				</tr>	
			</table>
		</div>
